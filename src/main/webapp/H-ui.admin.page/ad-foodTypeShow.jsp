...
<head>
    ...
    <title>ad-foodTypeShow.jsp</title>
    <script>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont"></i> 批量删除</a>
				...
				<a class="btn btn-primary radius" onclick="picture_add('添加图片','H-ui.admin.page/ad-foodTypeAdd.jsp')" href="javascript:;"><i class="Hui-iconfont"></i> 添加商品类别</a></span>
            ...
            <div class="mt-20">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div id="DataTables_Table_0_filter" class="dataTables_filter"></div><table class="table table-border table-bordered table-bg table-hover table-sort dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                    ...
                    <c:forEach items="${requestScope.foodTypeList}" var="user">
                        <tr class="text-c" role="row">
                            ...
                            <td class="td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" onclick="picture_edit('图库编辑','H-ui.admin.page/ad-foodTypeUpdate.jsp?id=${user.id}&typeName=${user.typeName}',${user.id})" href="javascript:;" title="编辑">
                                    <i class="Hui-iconfont"></i>
                                </a>
...
<script type="text/javascript">
    ...
    function dinner_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            */
            //alert(id);
            $.getJSON("http://localhost:8770/Catcoffee/foodTypeServlet","action=delFoodType&id="+id,
                function (data) {
                if (data.delFoodType>0){
                    $(obj).parents("tr").remove();
                    layer.msg('已经删除!',{icon: 5,time:1000});
                }
                else{
                    layer.msg('不能删除，还有食物在该分类下!',{icon: 5,time:1500});
                }
                });
