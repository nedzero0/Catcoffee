    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <table class="layui-table"
                   lay-data="{width: 892, height:330, url:'http://localhost:8770/Catcoffee/ordersServlet?action=userOrderDTs&userId=${sessionScope.Users.id}', page:true, id:'idTest'}"
                   lay-filter="demo">
                <thead>
                <tr>
        ...
        <div style="margin-left: 50px">
            <button type="button" class="layui-btn buttonPay">支付</button>
        </div>
...
<script>
    layui.use('table', function () {
        ...
        /* var table = layui.table;
         table.render({
             elem: '#test'
             ,url:'http://localhost:8770/Catcoffee/ordersServlet?action=userOrderDTs&userId=

        ${sessionScope.Users.id}'
            ,cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            ,cols: [[
