            ...
            <form class="layui-form" action="userServlet?action=updateUser" method="post">
                ...
                <div class="layui-form-item" style="display: none">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="id" value="${sessionScope.Users.id}" lay-verify="nickname" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="account" value="${sessionScope.Users.account}" readonly  lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item" style="display: none">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="password" value="${sessionScope.Users.password}" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" value="${sessionScope.Users.name}" lay-verify="nickname" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="age" value="${sessionScope.Users.age}" lay-verify="nickname" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">电话</label>
                    <div class="layui-input-inline">
                        <input type="text" name="phone" value="${sessionScope.Users.phone}" lay-verify="nickname" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">地址</label>
                    <div class="layui-input-block">
                        <input type="text" name="address" value="${sessionScope.Users.address}" required  lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="display:none;">
                    <label class="layui-form-label">img</label>
                    <div class="layui-input-block">
                        <input type="text" name="img" value="${sessionScope.Users.img}" required  lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
                    </div>
                </div>
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            ...
                            <div class="layui-card-body" pad15="">
                                <form class="layui-form" action="userServlet?action=updatePass&id=${sessionScope.Users.id}" method="post">
